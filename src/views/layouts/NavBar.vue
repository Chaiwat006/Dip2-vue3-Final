...
<template>
    <nav class="navbar navbar-expand-lg navbar-dark shadow" style="background: #993399;">
        <div class="container">
            <RouterLink :to="{ name: 'home' }" class="navbar-brand">7 ประเทศน่าอยู่</RouterLink>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <i class="bi bi-bank2 me-1"></i>ประเทศ
                        </a>

                        <ul class="dropdown-menu">
                            <li>
                                <RouterLink :to="{ name: 'wonders' }" class="dropdown-item">ประเทศ
                                </RouterLink>
                            </li>
                            <li>
                                <RouterLink :to="{ name: 'add-wonder' }" class="dropdown-item">เพิ่มประเทศ
                                </RouterLink>
                            </li>
                            <li><a class="dropdown-item" href="#">แก้ไขประเทศ</a></li>
                            <li><a class="dropdown-item" href="#">ลบประเทศ</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="https://www.wonderspodcast.com/wonders">เว็บไซต์ ประเทศ</a></li>
                        </ul>
                    </li>
