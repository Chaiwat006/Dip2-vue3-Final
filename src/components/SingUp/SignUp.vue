...
<template>
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-5 mb-1">
                <div class="card shadow">
                    <div class="card-header p-0">
                        <img src="https://p16-va.lemon8cdn.com/tos-alisg-v-a3e477-sg/o8X9BOfQqIEeBA5hETwC7vA4Wgi4ZCBAlEstAi~tplv-tej9nj120t-origin.webp"
                            class="card-img-top" alt="sign">
                    </div>
                    <div class="card-body">
                        <p class="card-text text-end">7 ประเทศ น่าอยู่ 2024.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-7">
                <div class="card shadow">
                    <div class="card-header text-white" style="background: #8B4513">
                    ...
                    <div class="card-body">
                        <form @click.prevent>
                            ...
                            <div class="mb-2">
                                <p type="submit" @click="submitForm" class="btn btn-primary shadow d-block" style="background: #8B4513">สมัครสมาชิก</p>
